...
const EntryIcon = ({ size = 20, className = "" }) => (
    ...
    >
        ...
        <path d="M13.333 3.66669L13.333 16.3334" stroke="#1C274C" stroke-linecap="round" />
        <path d="M6.66699 3.66669L6.66699 16.3334" stroke="#1C274C" stroke-linecap="round" />
        <path d="M3.66699 6.66669L6.66699 6.66669M16.3337 6.66669L13.3337 6.66669" stroke="#1C274C" stroke-linecap="round" />
        <path d="M3.66699 13.3333L6.66699 13.3333M16.3337 13.3333L13.3337 13.3333" stroke="#1C274C" stroke-linecap="round" />
        <path d="M3.33301 10H16.6663" stroke="#1C274C" stroke-linecap="round" />
    </svg>
);
